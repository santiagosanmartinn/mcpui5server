...
const recommendationPolicySchema = z.object({
  ...
  autoPromoteSkillSignalMode: z.boolean().optional(),
  autoPromoteMinSuccessExecutions: z.number().int().min(1).max(1000).optional(),
  autoPromoteMinSuccessRate: z.number().min(0).max(1).optional(),
  autoPromoteMinQualifiedSkills: z.number().int().min(1).max(20).optional(),
